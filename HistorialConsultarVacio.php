...
<form id="form2" name="form2" method="post" action="">
      <p class="identificacionL">Identificacion.</p>
         <input type="text" name="identificacion" class="identificacion"  readonly />
     <p class="nombreL1">Nombre.</p>
         <input type="text" name="nombre" class="nombre1"  readonly />
	 <p class="apellidoL1">Apellido.</p>
	     <input type="text" name="apellido" class="apellido1"  readonly />
	 <p class="telefonoL">Telefono.</p>
	     <input type="text" name="telefono" class="telefono"  readonly />
	 <p class="generoL">Genero.</p>
	     <input type="text" name="genero" class="genero"  readonly />
	 <p class="edadL">Edad.</p>
	     <input type="text" name="edad" class="edad"  readonly />
	 <p class="correo1L">Correo.</p>
	     <input tipe="text" name="correo" class="correo1"  readonly />
     <p class="direccion1L">Direccion.</p>
	     <input type="text" name="direccion" class="direccion1"  readonly />
	 ...
	 <p class="documentoEL">Documento.</p>
	    <input type="text" name="documentoE" class="documentoE"  readonly />
	 <p class="nombreEL">Nombre.</p>
	    <input type="text" name="nombreE" class="nombreE"  readonly />
	<p class="apellidoEL">Apellido.</p>
	    <input type="text" name="apellidoE" class="apellidoE"  readonly />
	<p class="telefonoEL">Telefono.</p>
	    <input type="text" name="telefonoE" class="telefonoE"  readonly />
	<p class="correoEL">Correo especialista.</p>
	    <input type="text" name="correoE" class="correoE"  readonly />
	...
	<p class="motivoCL">Motivo de la consulta.</p>
	   <input type="text" name="motivo" class="motivoC" readonly />
	<p class="enfermedadL">Enfermedad actual.</p>
	   <input type="text" name="enfermedad" class="enfermedad"  readonly />
	<p class="alergiaL">Alergias.</p>
	   <input type="text" name="alergia" class="alergia"  readonly />
	<p class="notaL">Notas.</p>
	   <input type="text" name="nota" class="nota"  readonly />	
