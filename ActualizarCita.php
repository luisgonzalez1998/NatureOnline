...
<form id="form1" name="form1" method="post" action="ModificarCitaC.php">
		  ...
		  <input type="text" name="documentoC" class="documento" value="<?php echo $idC ;?>" />
	  		  
		  <div class="linea"></div> 		  
		 <p class="datosEL">Datos del especialista.</p>
		 <p class="nombreEL">documento:</p>
		 <input type="text" name="documentoE" class="nombree" value="<?php echo $idE ;?>"  />
		...
		<input type="date" name="fecha" class="fecha" value="<?php echo $fecha ;?>" />
		<p class="horaL" >Hora:</p>
		<input type="time" name="hora" class="hora" value="<?php echo $hora ;?>" />
